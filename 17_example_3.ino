...
#define _DUTY_MIN 500  // 서보 최대 시계방향 위치 (0도)
#define _DUTY_NEU 1500  // 서보 중립 위치 (90도)
#define _DUTY_MAX 2500  // 서보 최대 반시계방향 위치 (180도)

#define _DIST_MIN  100.0   // 최소 거리 100mm
#define _DIST_MAX  250.0   // 최대 거리 250mm

#define EMA_ALPHA  0.5     // EMA 필터용 알파값
...
void loop()
{
  ...
  dist_ema = EMA_ALPHA * dist_raw + (1 - EMA_ALPHA) * dist_ema; // EMA 필터 적용

  // 거리 값을 _DUTY_MIN에서 _DUTY_MAX로 매핑
