...
#define _DUTY_MAX 2090 // 2000
#define _DUTY_NEU 1605 // 1500
#define _DUTY_MIN 590 // 1000

#define _SERVO_ANGLE_DIFF  33  // Replace with |D - E| degree
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(7, 0.5, 0));
...
float volt_to_distance(int a_value)
{
  ...
  return 555 + (-1.81 * a_value) + 1.47 * pow(10, -3) * a_value * a_value;
}
